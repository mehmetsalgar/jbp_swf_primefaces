...
jQuery.extend({
	...
	httpData: function( xhr, type, s ) {
		...
		if (ct.indexOf("text") >=0 ) {
			...
			if(data.indexOf("<partialResponse>") >= 0) {	
				data = data.substring(data.indexOf("<?xml version=\"1.0\" encoding=\"UTF-8\"?><partialResponse>"), data.indexOf("</partialResponse>") + "</partialResponse>".length);				
